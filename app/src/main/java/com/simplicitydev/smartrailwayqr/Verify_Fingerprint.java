...
public class Verify_Fingerprint extends Activity implements MFS100Event {
    ...
    private FingerData enrollFingerData = null;
                   ...
                   /* reference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for(DataSnapshot d: dataSnapshot.getChildren()){
                                enrollFingerData=d.getValue(FingerData.class);

                                 Enroll_Template = new byte[enrollFingerData.ISOTemplate().length];
                                 System.arraycopy(enrollFingerData.ISOTemplate(), 0, Enroll_Template, 0,
                                       enrollFingerData.ISOTemplate().length);

                                SetData2(lastCapFingerData);
                                if(score>=96){
